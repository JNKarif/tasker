...
export default function AddTaskModal({ onSave, taskToUpdate, onCloseClick }) {
  ...
  const [isAdd, setIsAdd] = useState(Object.is(taskToUpdate, null)); //to check that user wants to add or edit we have created a mode
  ...
  const handleChange = (e) => {
    ...
    setTask({
      ...task, // destructuring above task object from initital state
      [name]: value,
    });
  };
